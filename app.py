...
# 4. Inicialização Segura do Cliente da API (Correção de st.environ)
api_key = None

if "GEMINI_API_KEY" in st.secrets:
    api_key = st.secrets["GEMINI_API_KEY"]
else:
    # Correção: Uso correto da biblioteca 'os' para buscar o ambiente local se necessário
